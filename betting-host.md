...
```
- list of bets which are the format of `Bet:<product>:<selections>:<stake>`
- result which is the format of `Result:<first>:<second>:<third>`
```

output 

```
- list of all winning products with `<product>:<winningSelections>:$<dividend>`
```